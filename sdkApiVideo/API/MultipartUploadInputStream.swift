...
class MultipartUploadInputStream: InputStream {
    ...
    init(inputStream: InputStream, fileName: String, partName: String, contentType: String, chunkStart: Int64, chunkEnd: Int64, semaphore: DispatchSemaphore) {
        ...
        self.size = Int64(prefixData.count) + Int64(postfixData.count) + (chunkEnd - chunkStart)
